...
//Register new user
//POST
//POST DATA sample {"EmailAddress":"emailladdress","Name":"Pamidu","Password":"admin","ConfirmPassword":"admin"}
...
func Email(receiver, token string, emailtype string) string {
	res := "FALSE"
	from := mail.Address{"", "emailladdress"}
	...
	auth := smtp.PlainAuth("", "emailladdress", "password", host)
